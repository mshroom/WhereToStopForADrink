...
public class AlgorithmControllerTest {
    ...
    public void comparingPathAlgorithmsIncludesDataOfAllAlgorithms() throws Throwable {
        String result = algo.compareShortestPathAlgorithms(graphs.createSmallGraphForPathfinding2(), 4, graphs.createFakeDistancesForAStarGraph(graphs.createSmallGraphForPathfinding2(), 4));
    ...
    public void comparingPathAlgorithmsIncludesValidPaths() throws Throwable {
        String result = algo.compareShortestPathAlgorithms(graphs.createSmallGraphForPathfinding2(), 3, graphs.createFakeDistancesForAStarGraph(graphs.createSmallGraphForPathfinding2(), 3));
    ...
    public void comparingRouteAlgorithmsncludesDataOfAllAlgorithms() throws Throwable {
        String result = algo.compareShortestRouteAlgorithms(graphs.createSmallCompleteGraph(), true);
